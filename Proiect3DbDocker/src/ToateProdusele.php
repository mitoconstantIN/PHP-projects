        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">Toate produsele</p>
                </div>
            </div>
        </header>
        <svg width="400" height="100">
  <rect width="100000" height="20" 
  style="fill:black;stroke-width:10;stroke:rgb(0,0,0)" />
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-auto">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="multimedia/stile_capri.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Peroni Stile Capri 0.330</h5>
                                    <!-- Product reviews-->
                                    ...
                                    <!-- Product price-->
                                    <span class="text-muted text-decoration-line-through">15 RON</span>
                                    12 RON
                                </div>
                            </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-auto">
                            ...
                            <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Sale</div>
                            <!-- Product image-->
                            <img class="card-img-top" src="multimedia/pahar__vin.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Pahar Vin rosu</h5>
                                    <!-- Product price-->
                                    <span class="text-muted text-decoration-line-through">15 RON</span>
                                    10 RON
                                </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-auto">
                            <!-- Product image-->
                            <img class="card-img-top" src="multimedia/paulaner.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Paulaner 500ml</h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-auto">
                            ...
                            <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Sale</div>
                            <!-- Product image-->
                            <img class="card-img-top" src="multimedia/apa.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Apa plata</h5>
                                    <!-- Product price-->
