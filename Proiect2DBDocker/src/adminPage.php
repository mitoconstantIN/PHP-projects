...
<html lang="en">
    ...
    <body>
        ...
        <div align="center">
            ...
            {
                echo "<tr>";
                echo "<td>" . $document->_id . "</td>"; // Presupunând că _id este numele câmpului ID în MongoDB
                echo "<td>" . $document->username . "</td>";
                echo "<td>" . $document->password . "</td>";
                echo "<td>" . $document->role . "</td>";
                echo "<td><img style='width:50px;height:50px;' src='" . $document->image . "'></td>";
                echo "<td><a href=\"update.php?id=".$document->_id."\">Update</a>
                      <a href=\"delete.php?id=".$document->_id."\">Delete</a>
                      <a href=\"insert.php?id=".$document->_id."\">Insert</a></td>";
                echo "</tr>";
            }
            echo "</table>";
            ?>
